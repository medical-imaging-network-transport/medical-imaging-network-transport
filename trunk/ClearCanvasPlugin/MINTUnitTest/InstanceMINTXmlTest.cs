...
namespace MINTUnitTest
{
    ...
    public class InstanceMINTXmlTest
    {
        ...
        //    DicomAttributeCollection normalizedInstanceAttributes)
            ...
            var instance = new InstanceMINTXml(loaderArgs, "some-uri", doc.DocumentElement,
                studyAttributes, seriesAttributes, null);
            ...
            Assert.IsInstanceOfType(instance[DicomTags.ReferencedImageSequence], typeof(DicomAttributeSQ));
